...
const cardData = [
  {
    title: 'Why do I trust AI more in Java than in bash?',
    description: 'My skepticism rises and falls with how well I know the language — exactly where AI is most useful, and most risky.',
    label: 'Human-AI Interaction'
  },
  {
    title: 'What would a tool that helped me not accept code look like?',
    description: 'Most AI coding tools are designed around the accept button. The harder problem is making rejection feel as natural as acceptance.',
    label: 'Developer Tools'
  },
  {
    title: 'What happens to learning when AI writes the boilerplate?',
    description: 'Boilerplate is how junior developers learned a system\'s shape. When AI writes it for them, that path through the path goes missing.',
